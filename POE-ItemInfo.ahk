...
AffixDetailEllipsis := "бн"     ; If the MirrorLineFieldWidth is set to a value that is smaller than the actual length of the affix line text
...
XButton1::Send {Enter}/oos {Enter}
XButton2::Send {Enter}/itemlevel {Enter}
Ins::Send {Enter}/remaining {Enter}
^Space::
    Send g
    Sleep 15
    Send x
